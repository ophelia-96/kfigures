...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'product.noproducts': 'No products available at the moment.',
    ...
    tr: {
      ...
      'product.inquire': 'Detay Al',
      'product.outofstock': 'Stokta Yok',
      'product.price.from': 'Başlangıç',
      'product.loading': 'Ürünler yükleniyor...',
      'product.noproducts': 'Şu an ürün bulunmuyor.',
  ...
  window.translator = {
    translatePage: () => applyTranslations(currentLang)
  };
